...
ggsave("linear_regression_r_block_output.png", plot)
print(plot)
summary(model)

# to run script on Terminal --> 'Rscript linear_regression_r_block.R ../regression_data.csv YearsExperience Salary'